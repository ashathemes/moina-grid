...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'moina-grid' ); ?></a>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<button class="screen-reader-text menu-close"><?php esc_html_e( 'Close Menu', 'moina-grid' ); ?></button>
					<div class="mainmenu">
						<?php
							wp_nav_menu( array(
